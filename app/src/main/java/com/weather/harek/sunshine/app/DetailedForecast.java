...
public class DetailedForecast extends ActionBarActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            String forecastDetailstr = intent.getStringExtra(Intent.EXTRA_TEXT);
            ((TextView) rootView.findViewById(R.id.forecast_detail_text)).setText(forecastDetailstr);
            return rootView;
        }
    }
}
