...
import com.weather.harek.sunshine.app.data.WeatherContract;
...
public class ForecastFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        forecastsAdapter = new ForecastAdapter(getActivity(), cur, 0);
    ...
    private void updateWeather() {
        ...
        //String tempUnit = prefs.getString(getString(R.string.pref_temp_units_key), getString(R.string.pref_temp_units_metric));
        //String settings[] = {location, tempUnit};
...
//                    forecastsAdapter.add(day_forecast);
//            }
//        }
//    }
}
